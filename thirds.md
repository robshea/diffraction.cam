...
<table id="diff-table" aria-describedby="legend-table">
  ...
  <thead>
    <tr>
      <th colspan="2" rowspan="2" id="f-stop" scope="colgroup"><i class="fa-duotone fa-light fa-aperture" aria-hidden="true"></i> ƒ-stops<br /> (<a id="thirds-toggle" href="">whole</a>)</th>
